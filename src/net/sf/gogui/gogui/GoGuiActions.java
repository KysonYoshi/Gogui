...
import java.io.File;
import net.sf.gogui.boardpainter.DrawGoBoard;
import net.sf.gogui.boardpainter.DrawHexBoard;
import net.sf.gogui.boardpainter.GoFieldFactory;
import net.sf.gogui.boardpainter.HexFieldFactory;
...
import net.sf.gogui.rule.Gomoku;
import net.sf.gogui.rule.Go;
import net.sf.gogui.rule.Hex;
import net.sf.gogui.rule.OOGomoku;
...
public class GoGuiActions
{
    ...
    public final GuiAction m_actionForwardMaxNode =
        new GuiAction(i18n("ACT_FORWARD_MAX"), i18n("TT_FORWARD_MAX"),
                      KeyEvent.VK_RIGHT, "gogui-next") {
            public void actionPerformed(ActionEvent e) {
                m_goGui.actionForwardMaxNode(1); } };
    ...
    public final GuiAction m_actionSearchPattern =
        new GuiAction(i18n("ACT_SEARCH_PATTERN"), i18n("TT_SEARCH_PATTERN"),
                      KeyEvent.VK_F, "search-pattern") {
            public void actionPerformed(ActionEvent e) {
                m_goGui.actionFindFromTextField(); } };
    ...
    public final GuiAction m_actionToggleShowRZone =
        new GuiAction(i18n("ACT_RZONE")) {
            public void actionPerformed(ActionEvent e) {
                m_goGui.actionToggleShowRZone(); } };
    ...
    public void update()
    {
        ...
        m_actionForwardMaxNode.setEnabled(hasChildren);
        ...
        m_actionToggleShowRZone.setSelected(m_goGui.getShowRZone());
